    ...
    const Item = ({displayName, name}: ItemProps) => (
      <View style={Drawerstyling.Maincon}>
        {displayName == 'Funds' ? (
          ...
          <>
            <TouchableOpacity
              style={Drawerstyling.Innercothree}
              onPress={navtoPhoneEmailConfig}>
              <View style={Drawerstyling.Innertwoone}>
                <Text
                  style={[
                    Drawerstyling.texticon,
            ...
            <View>
              <TouchableOpacity
                ...
                <View style={Drawerstyling.usagecon}>
                  <Text style={Drawerstyling.styleb}>{t(name)}</Text>
                </View>
              </TouchableOpacity>
            </View>
          </>
            ...
            <View style={Drawerstyling.Innercokyc}>
              ...
              <View style={Drawerstyling.Buttomtxtcon}>
                <View
                  ...
                  <Text style={Drawerstyling.versiontxt}>Version 1.0.2.0</Text>
